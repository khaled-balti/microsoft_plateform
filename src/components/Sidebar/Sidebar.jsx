      ...
      <div className='container p-4'>
        <div className='d-flex flex-column align-items-center mt-3'>
            <div className='avatar me-4'>
                <img src={`${backendUrl}${user.image}`} alt='User' className='img-fluid' />
            </div>
            <div>
        ...
        <div className='container'>
            <div className='fw-bold mt-4 mb-3 ms-3 text-white' style={{fontSize: '14px'}} >DATA</div>
                <div>
                    ...
                    >
                        <FaShopLock /><span className='ms-3'>Providers</span>
                    </NavLink>
                    ...
                    >
                        <FaUserTie /><span className='ms-3'>Clients</span>
                    </NavLink>
        ...
        {(user.role === "admin" || user.role === "superadmin") && <div className='container mt-5'>
            ...
            >
                <FaUser /><span className='ms-3'><FaMoneyCheckDollar/> Sales</span>
            </NavLink>
            <NavLink 
