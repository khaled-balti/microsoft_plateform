      ...
      <div className="data-core w-100 py-3 px-4 d-flex flex-column align-items-center">
        ...
        <div className="container w-100">
          <div className="w-100 d-flex flex-column mb-3">
            <label htmlFor="client" className="mb-2 fs-5 fw-semibold">Client:</label>
            <select
              name="client"
              id="client"
          ...
          <div className="w-100 d-flex flex-column mb-3">
            <label htmlFor="provider" className="mb-2 fs-5 fw-semibold">Provider:</label>
            <select
              name="provider"
              id="provider"
              className="inputs px-2 py-3"
            ...
            >
              <option value="" hidden>Select a provider</option>
